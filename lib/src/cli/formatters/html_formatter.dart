...
''' +
  ...
  <script>
    (() => {
      ...
      if (recoverySignal) statusWarnings.push('Recovery required: do not assume rollback restored the original state.');
      ...
      if (Number(transactions.recoveryRequired || 0) > 0) statusWarnings.push('One or more transactions require recovery. Do not assume rollback restored the original state.');
