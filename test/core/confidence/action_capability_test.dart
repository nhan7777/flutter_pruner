...
void main() {
  group('ActionCapability.forFinding', () {
    test(
      'delegates to l10n capability for l10n nodes with readiness entry',
      () {
    ...
    test(
      'uses generic capability for non-l10n adapters with readiness entry',
      () {
        final node = GraphNode(
          id: 'custom:asset1',
          kind: NodeKind.asset,
        ...
        expect(
          ...
          isNull,
        ); // custom adapter has no description
      },
    );
